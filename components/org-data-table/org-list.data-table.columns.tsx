...
export const orgListDataTableSchema = z.object({
  id: z.number(),
  header: z.string(),
  type: z.string(),
  status: z.string(),
...
type OrgListDataTableRow = z.infer<typeof orgListDataTableSchema>;
...
function TableCellViewer({ item }: { item: OrgListDataTableRow }) {
...
export const orgListDataTableColumns: ColumnDef<OrgListDataTableRow>[] = [
  {
    id: "drag",
    header: () => null,
