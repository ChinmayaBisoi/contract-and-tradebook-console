...
const replacements = {
  ...
  __OPENAI_API_KEY_SECRET_ARN__: process.env.OPENAI_API_KEY_SECRET_ARN,
  ...
  __LOG_LEVEL__: process.env.LOG_LEVEL,
  __UPLOADTHING_WORKBOOK_ACL__: process.env.UPLOADTHING_WORKBOOK_ACL,
  __OPENAI_MAPPING_MODEL__: process.env.OPENAI_MAPPING_MODEL,
};
